...
It offers abstracted functions, built on top of other open-source projects like Pandas, Apache Arrow, Boto3, s3fs, SQLAlchemy, Psycopg2 and PyMySQL to execute usual ETL tasks like load/unload data from Data Lakes, Data Warehouses and Databases.
...
Read Apache Parquet file(s) from a received S3 prefix or list of an S3 object
...
<table border="1" class="dataframe"> <thead> <tr style="text-align: right;"> <th></th> <th>star_rating</th> <th>review_body</th> <th>product_category</th> </tr> </thead> <tbody> <tr> <th>0</th> <td>5</td> <td>Love it!</td> <td>Digital_Software</td> </tr> <tr> <th>1</th> <td>5</td> <td>Good product.</td> <td>Digital_Software</td> </tr> <tr> <th>2</th> <td>5</td> <td>I've been purchasing Turbotax for over a decad...</td> <td>Digital_Software</td> </tr> <tr> <th>3</th> <td>5</td> <td>Surprisingly effective and free too!</td> <td>Digital_Software</td> </tr> <tr> <th>4</th> <td>4</td> <td>Overall, the free Avast antivirus is pretty go...</td> <td>Digital_Software</td> </tr> </tbody> </table>
...
* If chunked=INTEGER, Wrangler will iterate on the data by a number of rows equal to the received INTEGER.

P.S. chunked=True is faster and uses less memory while chunked=INTEGER is more precise in a number of rows for each Dataframe.
...
Check the queries that you already run
