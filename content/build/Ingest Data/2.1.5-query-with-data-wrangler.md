...
Read Apache Parquet file(s) from from a receifrom a received S3 prefix or list of S3 object
...
Navigate to Amazon Athena, Query Editor to check the queries that you already run
